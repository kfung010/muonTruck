...
dataHandler = utils_likelihood.DataHandler([basename+".root"], basename, voxel_size=10)
...
eventInfo_files = [f"{basename}_likelihood_eventBasedVar_batch_*.npz"]
...
density_storeTo = f"{basename}_likelihood_scattering_density.npz"
